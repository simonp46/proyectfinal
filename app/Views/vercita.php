...
<head>
  ...
  <title>Ver Cita- Covid-19 Website</title>
...
<main>
    ...
    <style>
          ...
          .overlay {
            ...
            align-items: center;
            background: white;
            box-shadow: 0 0.75rem 2rem 0 rgba(211, 14, 14, 0.1);
            border-radius: 2rem;
...
<div class="container">
        ...
        <h5>No olvides cumplir con las medidas de bioserguridad al asistir a <b>Tu Vacuna.</b>        </h5>
        <hr><br>
<!-- Overlay -->
<div class="overlay">
  ...
  <div class="overlay__inner">
      ...
      <div class="mb-3 row">
        <label for="staticEmail" class="col-md-4 col-form-label">Cita No.</label>
        <input class="form-control" type="text" placeholder="IdCita" disabled> 
      </div>
    </div>
        <br>
    ...
    <div class="overlay__description">
      <div class="contenido__cita" >
        <table>
            <tbody>
                <tr><p class="overlay__description"><strong>Datos Paciente</strong></p></tr>
                <tr><td class="td"><p><b>Nro de Identificacion</p></td> <td class="td"><p>Aqui va el IdPaciente</p></td></tr>
                <tr><td class="td"><p><b>Nombres</p></td> <td class="td"><p>Aqui van los Nombres</p></td></tr>
                <tr><td class="td"><p><b>Apellidos</p></td> <td class="td"><p>Aqui van los Apellidos</p></td></tr>
    ...
    <div class="contenido__cita" >
        <table>
            <tbody>
                <tr><p class="overlay__description"><strong>Datos Vacunador</strong></p></tr>
                <tr><td class="td"><p><b> Vacunador</p></td> <td class="td"><p>Aqui va el IdVacunador</p></td></tr>
                <tr><td class="td"><p><b> Nombres</p></td> <td class="td"><p>Aqui van los Nombres</p></td></tr>
                <tr><td class="td"><p><b> Apellidos</p></td> <td class="td"><p>Aqui van los Apellidos</p></td></tr>
...
<div class="overlay__description">
 <div class="contenido__cita">
        <table>
            <tbody>
                <tr><p class="overlay__description"><strong>Detalles Cita</strong></p></tr>
                <tr><td class="td"><p><b>Fecha y Hora </p></td> <td class="td"><p>Aqui va la fecha y la hora</p></td></tr>
                <tr><td class="td"><p><b>Centro Medico</p></td> <td class="td"><p>Aqui va el nombre del centro medico</p></td></tr>        
                <tr><td class="td"><p><b>Direccion</p></td> <td class="td"><p>Direccion del centro</p></td></tr>        
            </tbody>
        </table>
    ...
    <p class="overlay__description">
      <strong>Vacunarse es un deber de la ciudadania.</strong>
    </p>
    <!-- Buttons -->
