    ...
    <div class="container">
        <div class="nav-frame">
            ...
            <nav class="nav-links" id="nav-links">
                <a href="index.html" class="nav-link active">Volver</a>
...
<form class="row g-3 needs-validation" novalidate>
  <div class="col-md-4">
    <label for="validationCustom05" class="form-label"><div class=""></div>Identificacion</label>
...
<div class="col-12">
  ...
  <input type="number" class="form-control" id="validationCustom03" aria-describedby="inputGroupPrepend" required>
  <div class="invalid-feedback">Por Favor rellena los datos correctamente.</div>
  ...
  <input type="email" class="form-control" id="validationCustom03" aria-describedby="inputGroupPrepend" required>
  <div class="invalid-feedback">Por Favor rellena los datos correctamente.</div>
  </div>
</div>
  ...
  <a href="/NuevaCita.html" class="nav-link1">Siguiente</a>
</form>
</div>
</main>
<!-- SCRIPTS -->
