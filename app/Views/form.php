...
<body>
  ...
  <main>
    ...
    <div class="container">
      ...
      <hr><br>
      <!-- FORMULARIO -->
      <form class="row g-3 needs-validation" method="POST" action="<?php base_url().'/crear'?>" novalidate>
        ...
        <div class="col-md-4">
          ...
          <input type="text" method="POST" class="form-control" id="identif" name="identif" required>
          <div class="invalid-feedback">Por Favor rellena los datos correctamente.</div>
        </div>

        <div class="col-md-4">
          <label for="validationCustom01" class="form-label">Nombres</label>
          <input type="text" class="form-control" id="name" name="name" method="POST" value="" required>
          <div class="valid-feedback">Correcto!</div>
        </div>

        <div class="col-md-4">
          <label for="validationCustom02" class="form-label">Apellidos</label>
          <input type="text" class="form-control" id="lastname" name="lastname" method="POST" value="" required>
        ...
        <div class="col-12">
          ...
          <input type="number" class="form-control" id="tel" name="tel" method="POST" aria-describedby="inputGroupPrepend" required>
          <div class="invalid-feedback">Por Favor rellena los datos correctamente.</div>
          ...
          <div class="input-group"> <span class="input-group-text" id="inputGroupPrepend">@</span>
            <input type="email" class="form-control" id="email" name="email" method="POST" aria-describedby="inputGroupPrepend" required>
            <div class="invalid-feedback">Por Favor rellena los datos correctamente.</div>
          </div>
        </div>
        ...
        <?php foreach($datos as $key): ?>
          <tr>
            ...
            <td>
            <a href="<?php echo base_url().'/guardar' ?>" class="nav-link1">Siguiente</a>
            </td>
          </tr>
        <?php endforeach; ?>
  ...
  if (mensaje == '1'){
    ...
    alert("Error de registro");}</script>
